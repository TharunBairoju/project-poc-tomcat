...
public class SwaggerConfig {
	...
	private Predicate<String> postPaths() {
		return or(regex("/api/posts.*"), regex("/api/javainuse.*"), regex("/employee.*"));
	}
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("SWAGGER TEST API")
				...
				.contact("tharun.it05@gmail.com").license("Swagger License")
				.licenseUrl("tharun.it05@gmail.com").version("1.0").build();
	}
